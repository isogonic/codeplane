...
let
  packageJson = lib.pipe ../packages/codeplane/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.intersection (lib.fileset.fromSource (lib.sources.cleanSource ../.)) (
      lib.fileset.unions [
        ...
        ../package.json
        ../patches
        ../.github/TEAM_MEMBERS # required by @codeplane-ai/script
      ]
    );
  };
