...
- PR #15835: https://github.com/devinoldenburg/codeplane/pull/15835

## Do Not Translate (Locale Additions)

- `Codeplane` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `codeplane` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Codeplane` in prose, `codeplane` only for exact technical identifiers
...
- Avoid changing `codeplane` to `Codeplane` inside commands, URLs, package names, or code literals
