...
Generates UPCOMING_CHANGELOG.md by running the codeplane changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for codeplane run (default: low)
      --quiet            Suppress codeplane command output unless it fails
