export const dict: Record<string, string> = {
  ...
  "ui.fileMedia.kind.table": "table",
  "ui.fileMedia.kind.html": "HTML",
  "ui.fileMedia.kind.markdown": "markdown",
  "ui.fileMedia.kind.json": "JSON",
  ...
  "ui.fileMedia.toggle.preview": "Preview",
  "ui.fileMedia.toggle.source": "Source",
  "ui.fileMedia.table.summary": "{{rows}} rows × {{cols}} columns",
  "ui.fileMedia.table.empty": "Table has no rows.",
  "ui.fileMedia.table.truncated": "Table truncated for preview.",
  "ui.fileMedia.html.label": "HTML preview",
  "ui.fileMedia.json.label": "JSON",
  "ui.fileMedia.json.invalid": "Invalid JSON: {{message}}",
  ...
  "ui.imagePreview.loading": "Loading image…",
  "ui.imagePreview.error": "Image failed to load",
  ...
  "ui.message.copyCode": "Copy code",
  "ui.message.copyPath": "Copy path",
  ...
  "ui.message.copiedCode": "Copied code",
  "ui.message.copiedPath": "Copied path",
  "ui.message.copiedLink": "Copied link",
  "ui.message.copiedText": "Copied text",
  "ui.message.copiedMessage": "Copied message",
  "ui.message.copiedResponse": "Copied response",
  "ui.message.reasoning": "Reasoning",
  "ui.message.reasoningMode": "Reasoning display",
  "ui.message.reasoningMode.short": "Short",
  "ui.message.reasoningMode.full": "Full",
  "ui.message.reasoningMode.off": "Off",
