...
import { DockPrompt } from "@codeplane-ai/ui/dock-prompt"
import { Icon } from "@codeplane-ai/ui/icon"
import { showToast } from "@codeplane-ai/ui/toast"
import type { QuestionAnswer, QuestionRequest } from "@codeplane-ai/sdk/v2"
import { useLanguage } from "@/context/language"
import { useSDK } from "@/context/sdk"
import { makeEventListener } from "@solid-primitives/event-listener"
import { createResizeObserver } from "@solid-primitives/resize-observer"
import { renderQuestionText } from "./question-text"
...
export const SessionQuestionDock: Component<{ request: QuestionRequest; onSubmit: () => void }> = (props) => {
  ...
  return (
    ...
    >
      <div data-slot="question-text">{renderQuestionText(question()?.question)}</div>
