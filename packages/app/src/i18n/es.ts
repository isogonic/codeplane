...
const translated = {
  "mcp.status.needs_client_registration": "requiere ID de cliente",
  "mcp.action.authorize": "Autorizar",
  "mcp.action.authorizing": "Autorizando…",
  "mcp.action.signOut": "Cerrar sesión",
  "mcp.toast.authorized": "{{name}} autorizado",
  "mcp.toast.authFailed": "Error de autorización",
  "mcp.toast.authTimeout": "Se agotó el tiempo de autorización; inténtalo de nuevo",
  "mcp.toast.notSupported": "Este servidor no admite OAuth",
  "mcp.toast.needsClientId": "Se requiere registro de cliente",
  "mcp.toast.signedOut": "Sesión cerrada",
  "mcp.toast.popupBlocked": "Permite las ventanas emergentes de este sitio y vuelve a autorizar",
  "mcp.oauth.clientRegistrationHint": "Este servidor necesita un client ID registrado previamente. Añade oauth.clientId a su configuración.",
  ...
  "dialog.provider.codeplane.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.codeplane.tagline": "Modelos optimizados y fiables",
  "dialog.provider.anthropic.note": "Conecta con una clave API de Anthropic",
  ...
  "provider.connect.apiKey.description": "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Codeplane.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codeplane.json",
  ...
  "settings.general.row.colorScheme.description": "Elige entre el tema claro u oscuro",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Añade Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> a los commits realizados mediante Codeplane",
  ...
  "login.subtitle": "Introduce tus credenciales para acceder a {{server}}",
  ...
  "login.hint": "Tus credenciales se almacenan solo en este dispositivo.",
  "login.otp.title": "Autenticación de dos factores",
  "login.otp.subtitle": "Introduce el código de 6 dígitos de tu aplicación de autenticación.",
  "login.otp.code": "Código de autenticación",
  "login.otp.placeholder": "123456",
  "login.otp.verify": "Verificar",
  "login.otp.verifying": "Verificando…",
  "login.otp.back": "Atrás",
  "login.otp.error": "Código inválido o caducado",
  "login.otp.hint": "Abre tu aplicación de autenticación para obtener el código actual.",
  "login.expired": "Tu sesión expiró. Vuelve a iniciar sesión para continuar.",
  "connect.title": "Conectar con Codeplane",
  "connect.subtitle": "Introduce una dirección de servidor para empezar.",
  "connect.address": "Dirección del servidor",
  "connect.placeholder": "local, una IP o un dominio",
  "connect.hint": "Prueba «local», una IP como 192.168.1.5 o un dominio.",
  "connect.signIn": "Iniciar sesión",
  "connect.connecting": "Conectando…",
  "connect.error": "No se pudo conectar con ese servidor. Verifica la dirección.",
