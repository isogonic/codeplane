...
const translated = {
  "mcp.status.needs_client_registration": "ID client requis",
  "mcp.action.authorize": "Autoriser",
  "mcp.action.authorizing": "Autorisation…",
  "mcp.action.signOut": "Se déconnecter",
  "mcp.toast.authorized": "{{name}} autorisé",
  "mcp.toast.authFailed": "Échec de l'autorisation",
  "mcp.toast.authTimeout": "Délai d'autorisation dépassé — réessayez",
  "mcp.toast.notSupported": "Ce serveur ne prend pas en charge OAuth",
  "mcp.toast.needsClientId": "Enregistrement du client requis",
  "mcp.toast.signedOut": "Déconnecté",
  "mcp.toast.popupBlocked": "Autorisez les fenêtres contextuelles pour ce site, puis réessayez l'autorisation",
  "mcp.oauth.clientRegistrationHint": "Ce serveur nécessite un ID client préenregistré. Ajoutez oauth.clientId à sa configuration.",
  ...
  "dialog.provider.anthropic.note": "Connectez-vous avec une clé API Anthropic",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Codeplane",
  ...
  "provider.connect.apiKey.description": "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Codeplane.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans codeplane.json",
  ...
  "dialog.server.description": "Changez le serveur Codeplane auquel cette application se connecte.",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (codeplane.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed": "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Codeplane ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Codeplane inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Codeplane",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Codeplane sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Codeplane suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Codeplane.",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Ajoute Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> aux commits effectués via Codeplane",
  ...
  "login.subtitle": "Saisissez vos identifiants pour accéder à {{server}}",
  ...
  "login.hint": "Vos identifiants sont stockés uniquement sur cet appareil.",
