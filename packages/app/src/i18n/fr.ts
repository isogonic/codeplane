export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CodePlane.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CodePlane.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CodePlane.",
  ...
  "toast.update.description":
    "Une nouvelle version d'CodePlane ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CodePlane ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CodePlane inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CodePlane dans WSL sur Windows.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CodePlane",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CodePlane.",
