...
const translated = {
  "mcp.status.needs_client_registration": "требуется client ID",
  "mcp.action.authorize": "Авторизовать",
  "mcp.action.authorizing": "Авторизация…",
  "mcp.action.signOut": "Выйти",
  "mcp.toast.authorized": "{{name}} авторизован",
  "mcp.toast.authFailed": "Не удалось авторизовать",
  "mcp.toast.authTimeout": "Истекло время авторизации — попробуйте снова",
  "mcp.toast.notSupported": "Этот сервер не поддерживает OAuth",
  "mcp.toast.needsClientId": "Требуется регистрация клиента",
  "mcp.toast.signedOut": "Выход выполнен",
  "mcp.toast.popupBlocked": "Разрешите всплывающие окна для этого сайта, затем попробуйте авторизоваться снова",
  "mcp.oauth.clientRegistrationHint": "Этому серверу нужен предварительно зарегистрированный client ID. Добавьте oauth.clientId в его конфигурацию.",
  ...
  "dialog.provider.codeplane.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.codeplane.tagline": "Надежные оптимизированные модели",
  "dialog.provider.anthropic.note": "Подключитесь с помощью API-ключа Anthropic",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Codeplane",
  ...
  "provider.connect.apiKey.description": "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Codeplane.",
  ...
  "dialog.plugins.empty": "Плагины настроены в codeplane.json",
  ...
  "dialog.server.description": "Переключите сервер Codeplane к которому подключается приложение.",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (codeplane.json)",
  "error.chain.mcpFailed": "MCP сервер \"{{name}}\" завершился с ошибкой. Обратите внимание, что Codeplane пока не поддерживает MCP авторизацию.",
  ...
  "sidebar.gettingStarted.line1": "Codeplane включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.appearance.description": "Настройте как Codeplane выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Codeplane системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Codeplane.",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Добавляет Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> к коммитам, созданным через Codeplane",
  ...
  "login.title": "Вход",
  "login.subtitle": "Введите учётные данные для доступа к {{server}}",
  ...
  "login.hint": "Ваши учётные данные хранятся только на этом устройстве.",
