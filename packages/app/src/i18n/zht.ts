...
export const dict = {
  ...
  "dialog.provider.codeplaneGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 CodePlane 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 CodePlane 中使用 {{provider}} 模型。",
  ...
  "toast.update.description": "CodePlane 有新版本 ({{version}}) 可安裝。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 CodePlane 伺服器。",
  ...
  "settings.updates.row.startup.description": "在 CodePlane 啟動時自動檢查更新",
