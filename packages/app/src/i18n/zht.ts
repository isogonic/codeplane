...
const translated = {
  ...
  "dialog.model.unpaid.freeModels.title": "Codeplane 提供的免費模型",
  ...
  "provider.connect.apiKey.description": "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Codeplane 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Codeplane 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Codeplane 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 codeplane.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Codeplane 伺服器。",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (codeplane.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器 \"{{name}}\" 啟動失敗。注意: Codeplane 暫不支援 MCP 認證。",
  ...
  "sidebar.gettingStarted.line1": "Codeplane 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Codeplane 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Codeplane 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Codeplane 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Codeplane 的主題。",
  ...
  "settings.general.row.codeplaneCoauthor.description": "為透過 Codeplane 建立的提交加入 Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com>",
  ...
  "login.error": "使用者名稱或密碼不正確",
  "login.hint": "您的憑證僅儲存在此裝置上。",
