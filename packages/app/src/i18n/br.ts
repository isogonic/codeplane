export const dict = {
  ...
  "dialog.provider.codeplaneGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CodePlane.",
  ...
  "provider.connect.codeplaneZen.line1":
    "CodePlane Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CodePlane.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CodePlane.",
  ...
  "toast.update.description": "Uma nova versão do CodePlane ({{version}}) está disponível para instalação.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CodePlane dentro do WSL no Windows.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CodePlane iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CodePlane.",
