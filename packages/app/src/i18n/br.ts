...
const translated = {
  ...
  "dialog.provider.codeplane.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codeplane.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.anthropic.note": "Conectar com uma chave de API da Anthropic",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Codeplane",
  ...
  "provider.connect.apiKey.description": "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Codeplane.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codeplane.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Codeplane este aplicativo se conecta.",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codeplane.json)",
  "error.chain.mcpFailed": "Servidor MCP \"{{name}}\" falhou. Nota: Codeplane ainda não suporta autenticação MCP.",
  ...
  "sidebar.gettingStarted.line1": "Codeplane inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Codeplane",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Codeplane aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Codeplane segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Codeplane é tematizado.",
  ...
  "settings.general.row.codeplaneCoauthor.title": "Coautor do Codeplane",
  "settings.general.row.codeplaneCoauthor.description": "Adiciona Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> aos commits feitos pelo Codeplane",
  ...
  "login.title": "Entrar",
  "login.subtitle": "Insira suas credenciais para acessar {{server}}",
  ...
  "login.hint": "Suas credenciais são armazenadas apenas neste dispositivo.",
