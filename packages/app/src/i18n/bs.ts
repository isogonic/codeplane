...
const translated = {
  ...
  "provider.connect.apiKey.description": "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Codeplane-u.",
  ...
  "provider.connect.oauth.code.visit.suffix": " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Codeplane-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Codeplane-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codeplane.json",
  ...
  "settings.general.row.colorScheme.description": "Odaberi svijetlu ili tamnu temu",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Dodaj Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> commitima napravljenim kroz Codeplane",
  ...
  "login.title": "Prijava",
  "login.subtitle": "Unesite svoje podatke za pristup {{server}}",
  "login.username": "Korisničko ime",
  "login.usernamePlaceholder": "codeplane",
  "login.password": "Lozinka",
  "login.passwordPlaceholder": "Unesite svoju lozinku",
  ...
  "login.hint": "Vaši podaci se pohranjuju samo na ovom uređaju.",
