export const dict = {
  ...
  "chat.sessions.empty": "No chats yet. Start a new conversation.",
  "chat.session.new": "New chat",
  "chat.session.untitled": "New chat",
  "chat.session.rename": "Rename",
  "chat.session.delete": "Delete",
  "chat.session.deleteConfirm": "Delete this chat? This cannot be undone.",
  "chat.session.renamePrompt": "Rename chat",
  "chat.session.messageCount.zero": "No messages",
  "chat.session.messageCount.one": "1 message",
  "chat.session.messageCount.other": "{{count}} messages",
  "chat.empty.title": "Your chats live here",
  "chat.empty.description":
    "Each session has its own filesystem and shares a common memory across conversations. Start a new chat to begin.",
  "chat.memory.title": "Memory",
  "chat.memory.help": "Notes shared across every chat session. Each entry is sent to the model as a separate piece of long-term context.",
  "chat.memory.subtitle": "Long-term notes the assistant sees on every send",
  "chat.memory.placeholder": "What should the assistant remember?",
  "chat.memory.titlePlaceholder": "Short title (optional)",
  "chat.memory.add": "Add memory",
  "chat.memory.delete": "Delete memory",
  "chat.memory.empty": "No memories yet. Click Add memory to capture a fact, preference, or instruction the assistant should keep across every chat.",
  "chat.memory.entryUntitled": "Untitled memory",
  "chat.memory.toggle": "Memory",
  "chat.liveActivity.tooltip.on": "Showing on Lock Screen — tap to stop",
  "chat.liveActivity.tooltip.off": "Show this chat on the Lock Screen",
  "chat.liveActivity.tooltip.limit": "{{max}} chats already on the Lock Screen — turn one off first",
  ...
  "chat.memory.count.zero": "No memories",
  "chat.memory.count.one": "1 memory",
  "chat.memory.count.other": "{{count}} memories",
  "chat.memory.savedToast.one": "Saved to memory",
  "chat.memory.savedToast.other": "Saved {{count}} memories",
  "chat.files.toggle": "Files",
  "chat.files.title": "Session files",
  "chat.files.help": "These files are scoped to this chat only and attached to every message.",
  "chat.files.add": "Add file",
  "chat.files.save": "Save file",
  "chat.files.editing": "Editing",
  "chat.files.empty": "No files in this session yet.",
  "chat.files.namePrompt": "File name",
  "chat.files.contentPrompt": "File contents",
  "chat.files.delete": "Delete file",
  "chat.files.charCount.zero": "0 chars",
  "chat.files.charCount.one": "1 char",
  "chat.files.charCount.other": "{{count}} chars",
  "chat.toolbar.sessions": "Chats",
  "chat.toolbar.model": "Model",
  "chat.toolbar.modelPick": "Pick a model",
  "chat.message.you": "You",
  "chat.message.assistant": "Assistant",
  "chat.message.thinking": "Thinking…",
  "chat.message.startHint": "Send a message to start the conversation.",
  "chat.message.copy": "Copy",
  "chat.message.copied": "Copied",
  "chat.message.savedToMemory": "Saved to memory",
  "chat.message.memoryToolUsed": "Saved to memory",
  "chat.message.memoryForgotten": "Removed from memory",
  "chat.message.memoryForget": "Forget this",
  "chat.file.preview": "Preview",
  "chat.file.previewClose": "Close preview",
  "chat.file.download": "Download",
  "chat.file.downloadPdf": "Download as PDF",
  "chat.file.tool.writeRunning": "Writing file…",
  "chat.file.tool.writeDone": "File written",
  "chat.file.tool.editRunning": "Editing file…",
  "chat.file.tool.editDone": "File edited",
  "chat.file.tool.readRunning": "Reading file…",
  "chat.file.tool.readDone": "File read",
  "chat.tool.using": "Used {{tool}}",
  "chat.tool.runningLabel": "Running…",
  ...
  "chat.model.notConnected": "No provider connected — Settings → Providers",
  "chat.model.cap.vision": "Supports image input",
  "chat.model.cap.tools": "Supports tool calls",
  "chat.model.cap.reasoning": "Supports reasoning / thinking",
  "chat.error.sendFailed": "Could not send message",
  "chat.error.noDirectory": "Could not resolve a working directory. Open a project once to initialize.",
  "sidebar.modes": "Modes",
