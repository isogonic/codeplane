export const dict = {
  ...
  "dialog.provider.anthropic.note": "Connect with an Anthropic API key",
  ...
  "provider.custom.models.fetch.success": "Fetched {{count}} models",
  "provider.custom.models.fetch.empty": "No models found",
  "provider.custom.models.fetch.error": "Could not fetch models from that provider",
  ...
  "app.server.otherServers": "Other instances",

  "login.title": "Sign in",
  "login.subtitle": "Enter your credentials to access {{server}}",
  ...
  "login.otp.subtitle": "Enter the 6-digit code from your authenticator app.",
  "login.otp.code": "Authentication code",
  "login.otp.placeholder": "123456",
  "login.otp.verify": "Verify",
  "login.otp.verifying": "Verifying…",
  "login.otp.back": "Back",
  "login.otp.error": "Invalid or expired code",
  "login.otp.hint": "Open your authenticator app to get the current code.",
  ...
  "dialog.server.search.placeholder": "Search instances",
  "dialog.server.empty": "No instances yet",
  "dialog.server.add.title": "Add instance",
  "dialog.server.add.url": "Instance address",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Could not reach this instance",
  "dialog.server.add.checking": "Checking...",
  "dialog.server.add.button": "Add instance",
  "dialog.server.add.name": "Instance name (optional)",
  ...
  "dialog.server.edit.title": "Edit instance",
  "dialog.server.default.title": "Default instance",
  "dialog.server.default.description":
    "Attach to this instance on app launch instead of starting a fresh local one. Requires restart.",
  "dialog.server.default.none": "No instance selected",
  "dialog.server.default.set": "Set current instance as default",
  "dialog.server.default.clear": "Clear",
  "dialog.server.action.remove": "Remove instance",
  ...
  "dialog.server.current": "Current instance",
  ...
  "home.stat.activeDays": "Active days",
  "home.stat.streak.current": "Current streak",
  "home.stat.streak.longest": "Longest streak",
  "home.stat.streak.value": "{{count}}d",
  "home.stat.peakHour": "Peak hour",
  "home.stat.preferredModel": "Preferred model",
  ...
  "home.fact.devin.behind": "Devin Oldenburg burns through ~{{ratio}}× more tokens per day than you.",
  "home.fact.tokens.novel": "That's ~{{count}} average paperback novels in tokens.",
  "home.fact.tokens.dune": "You used ~{{count}}× more tokens than the Dune novel.",
  "home.fact.tokens.lotr": "Enough tokens for ~{{count}}× The Lord of the Rings trilogy.",
  "home.fact.tokens.warAndPeace": "You've out-written War and Peace ~{{count}}×.",
  "home.fact.tokens.bible": "Your tokens equal ~{{count}} King James Bibles.",
  "home.fact.tokens.shakespeare": "~{{count}}× Shakespeare's complete works in tokens.",
  "home.fact.tokens.harryPotter": "~{{count}}× the entire Harry Potter series.",
  "home.fact.tokens.perMessage": "~{{count}} tokens per message — you feed the context generously.",
  "home.fact.messages.perActiveDay": "~{{count}} messages per active day on average.",
  "home.fact.messages.thousand": "{{count}}k messages sent — a small civilization of prompts.",
  "home.fact.messages.total": "{{count}} messages and counting.",
  "home.fact.streak.week": "{{count}}-day streak — longer than most New Year resolutions.",
  "home.fact.streak.month": "{{count}} days in a row — habit officially formed.",
  "home.fact.streak.legendary": "{{count}}-day streak — that's GitHub-graph green.",
  "home.fact.streak.bestEver": "Personal best streak: {{count}} days. Can you beat it?",
  "home.fact.activeDays.percent": "Active on {{count}} days — {{percent}}% of the year.",
  "home.fact.activeDays.workYear": "{{count}} active days — more than a full work year.",
  "home.fact.sessions.perWeek": "~{{count}} sessions per week — steady rhythm.",
  "home.fact.sessions.century": "{{count}} sessions completed — century club.",
  "home.fact.sessions.thousand": "{{count}}k sessions — you're basically running a fleet.",
  "home.fact.peakHour.midnight": "Peak at {{hour}}:00 — proper night owl.",
  "home.fact.peakHour.earlybird": "Peak at {{hour}}:00 — coffee before code.",
  "home.fact.peakHour.midday": "Peak at {{hour}}:00 — flow state, post-lunch fuel.",
  "home.fact.peakHour.afternoon": "Peak at {{hour}}:00 — the productive slope of the day.",
  "home.fact.peakHour.evening": "Peak at {{hour}}:00 — dinner can wait.",
  "home.activity.dayLabel": "{{count}} on {{date}}",
  "home.activity.empty": "No activity yet",
  "home.models.empty": "No model usage yet",
  "home.models.messages": "{{count}} msgs",
  "home.models.sessions": "{{count}} sessions",
  "home.models.tokens": "{{value}} tokens",
  ...
  "session.liveActivity.menu.on": "Stop showing on Lock Screen",
  "session.liveActivity.menu.off": "Show on Lock Screen",
  "session.liveActivity.menu.limit": "Lock Screen full ({{max}} sessions)",
  "sidebar.modes": "Modes",
  ...
  "settings.general.row.colorScheme.description": "Choose between the light or dark theme",
  ...
  "settings.general.row.computerUse.permissionsFooter":
    "If the toggle is already on in System Settings but still shows here as inactive, relaunch Codeplane Desktop so macOS reloads the permission.",
  ...
  "settings.general.row.computerUse.statusRelaunchRequired": "Relaunch required",
  ...
  "mcp.status.needs_client_registration": "needs client ID",
  "mcp.action.authorize": "Authorize",
  "mcp.action.authorizing": "Authorizing…",
  "mcp.action.signOut": "Sign out",
  "mcp.toast.authorized": "Authorized {{name}}",
  "mcp.toast.authFailed": "Authorization failed",
  "mcp.toast.authTimeout": "Authorization timed out — try again",
  "mcp.toast.notSupported": "This server does not support OAuth",
  "mcp.toast.needsClientId": "Client registration required",
  "mcp.toast.signedOut": "Signed out",
  "mcp.toast.popupBlocked": "Allow pop-ups for this site, then try authorizing again",
  "mcp.oauth.clientRegistrationHint":
    "This server needs a pre-registered client ID. Add oauth.clientId to its config.",
