export const dict = {
  ...
  "prompt.action.voiceStop": "Stop and send",
  "prompt.action.voiceTranscribing": "Transcribing…",
  "prompt.voice.listening": "Listening… click to send",
  ...
  "prompt.toast.voiceUnsupported.title": "Voice not supported",
  "prompt.toast.voiceUnsupported.description": "This browser doesn't expose the microphone or audio APIs needed for voice input.",
  "prompt.toast.voiceFailed.title": "Voice transcription failed",
  "prompt.toast.voiceModelMissing.title": "Voice model not selected",
  "prompt.toast.voiceModelMissing.description": "Pick a transcription model in Settings → Voice (or set localStorage 'codeplane-voice-model' to 'providerID:modelID', e.g. 'openai:whisper-1').",
  ...
  "settings.general.row.voiceModel.description":
    "Used for the mic button in the prompt input. Pick a connected provider and a model that supports audio transcription (e.g. openai / whisper-1).",
  "settings.general.row.voiceModel.providerPlaceholder": "Provider…",
  "settings.general.row.voiceModel.modelPlaceholder": "Model…",
