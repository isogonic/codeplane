export const dict = {
  ...
  "session.activity.stats.title": "Stats",
  "session.activity.stat.tools": "Tool calls",
  "session.activity.stat.models": "Model switches",
  "session.activity.stat.files": "Files touched",
  "session.activity.heatmap.title": "File heatmap",
  "session.activity.heatmap.empty": "No file changes yet",
