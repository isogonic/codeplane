...
const translated = {
  ...
  "dialog.provider.anthropic.note": "اتصل باستخدام مفتاح API من Anthropic",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Codeplane",
  ...
  "provider.connect.apiKey.description": "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Codeplane.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في codeplane.json",
  ...
  "dialog.server.description": "تبديل خادم Codeplane الذي يتصل به هذا التطبيق.",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (codeplane.json)",
  "error.chain.mcpFailed": "فشل خادم MCP \"{{name}}\". لاحظ أن Codeplane لا يدعم مصادقة MCP بعد.",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Codeplane نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Codeplane",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Codeplane على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Codeplane يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Codeplane.",
  ...
  "settings.general.row.codeplaneCoauthor.description": "أضف Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> إلى الالتزامات التي تُنشأ عبر Codeplane",
  ...
  "session.copyId": "نسخ معرف الجلسة",
  ...
  "login.subtitle": "أدخل بيانات اعتمادك للوصول إلى {{server}}",
  ...
  "login.hint": "يتم تخزين بيانات اعتمادك على هذا الجهاز فقط.",
