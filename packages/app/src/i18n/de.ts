...
export const dict = {
  ...
  "session.tab.activity": "Aktivität",
  "session.tab.context": "Kontext",
  "session.panel.reviewAndFiles": "Überprüfung und Dateien",
  "session.activity.stats.title": "Statistik",
  "session.activity.stat.tools": "Toolcalls",
  "session.activity.stat.models": "Modellwechsel",
  "session.activity.stat.files": "Angefasste Dateien",
  "session.activity.heatmap.title": "Datei-Heatmap",
  "session.activity.heatmap.empty": "Noch keine Dateiänderungen",
