...
export const dict = {
  ...
  "dialog.provider.codeplaneGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "home.stat.files": "Geänderte Dateien",
  "home.stat.lines": "Geänderte Zeilen",
  "home.stat.thisWeek": "Diese Woche",
  "home.stat.today": "heute",
  "home.stat.archived": "{{count}} archiviert",
  "home.activity.title": "Sitzungen im Zeitverlauf",
  "home.activity.subtitle": "Letzte 14 Tage",
  "home.activity.dayLabel": "{{count}} am {{date}}",
  "home.activity.empty": "Noch keine Sitzungen",
