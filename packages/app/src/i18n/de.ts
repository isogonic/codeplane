...
export const dict = {
  ...
  "dialog.server.default.description":
    "Beim App-Start mit dieser Instanz verbinden, anstatt eine neue lokale zu starten. Erfordert Neustart.",
  ...
  "settings.general.row.computerUse.permissionsFooter":
    "Wenn der Schalter in den Systemeinstellungen bereits aktiv ist, hier aber weiter als inaktiv erscheint, starte Codeplane Desktop neu, damit macOS die Berechtigung neu lädt.",
  "settings.general.row.computerUse.permissionsRelaunchFooter":
    "Die Berechtigung ist in den Systemeinstellungen aktiv, aber dieser laufende Codeplane-Prozess kann sie noch nicht verwenden. Starte Codeplane Desktop neu, um sie anzuwenden.",
