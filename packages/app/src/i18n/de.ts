...
export const dict = {
  ...
  "toast.update.description": "Eine neue Version von CodePlane ({{version}}) ist zur Installation verfügbar.",
  ...
  "settings.desktop.wsl.description": "CodePlane-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CodePlane automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von CodePlane.",
