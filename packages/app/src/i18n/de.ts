...
const translated = {
  ...
  "settings.tab.secrets.description": "Geheimnisse pro Instanz verwalten",
  "secrets.page.title": "Geheimnisse",
  "secrets.page.note": "Verwenden Sie {secret:name} in der Konfiguration. Werte werden in data/secrets/ gespeichert.",
  "secrets.page.add": "Geheimnis hinzufügen",
  "secrets.page.empty": "Keine Geheimnisse für diese Instanz gespeichert",
  "secrets.page.confirm.remove": "Geheimnis \"{{name}}\" löschen?",
  "secrets.editor.title.add": "Geheimnis hinzufügen",
  "secrets.editor.title.edit": "Geheimnis ersetzen",
  "secrets.editor.name": "Geheimnisname",
  "secrets.editor.name.error": "Geben Sie einen Geheimnisnamen ein.",
  "secrets.editor.value": "Geheimniswert",
  "secrets.editor.value.error": "Geben Sie einen Geheimniswert ein.",
  "secrets.toast.saved": "Geheimnis gespeichert",
  "secrets.toast.removed": "Geheimnis entfernt",
  ...
  "settings.general.row.computerUse.permissionsBody": "{{ tool }} benötigt {{count}} Systemberechtigungen, um den Desktop zu steuern. Codeplane braucht diese, um den Cursor zu bewegen, zu klicken, zu tippen, Screenshots zu machen und Apps für dich zu öffnen.",
  "settings.general.row.computerUse.permissionGranted": "Bereit",
  "settings.general.row.computerUse.permissionMissing": "Nicht aktiv — Einstellungen öffnen oder neu starten",
  "settings.general.row.computerUse.permissionRelaunchRequired": "Aktiviert — Neustart erforderlich",
  ...
  "settings.general.row.computerUse.permissionDescription.accessibility": "Erlaubt Codeplane, den Cursor zu bewegen, zu klicken, zu tippen und Tastenkürzel zu senden. Ohne diese Berechtigung schlagen alle Klick-/Tipp-Aktionen mit „nicht für Bedienungshilfen autorisiert“ fehl.",
  "settings.general.row.computerUse.permissionDescription.screenRecording": "Erlaubt Codeplane, den Bildschirm aufzunehmen, damit der Agent sieht, woran er gerade arbeitet. Ohne diese Berechtigung kommen Screenshots leer zurück oder schlagen fehl.",
