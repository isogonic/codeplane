...
const translated = {
  // Keys below previously fell back to English (de inherits from en via spread).
  // Filled in with formal-register German; brand names, acronyms (MCP/LSP),
  // app names, key labels, metric abbreviations and language endonyms are
  // intentionally left identical to en.
  "command.project.previous": "Vorheriges Projekt",
  "command.project.next": "Nächstes Projekt",
  "command.quickSwitcher.open": "Schnellauswahl",
  "quickSwitcher.title": "Schnellauswahl",
  "quickSwitcher.search.label": "Suchen",
  "quickSwitcher.search.placeholder": "Sitzungen, Projekte, Server suchen…",
  "quickSwitcher.empty": "Keine Treffer.",
  "quickSwitcher.section.sessions": "Sitzungen in diesem Projekt",
  "quickSwitcher.section.projects": "Projekte",
  "quickSwitcher.section.actions": "Aktionen",
  "quickSwitcher.action.browseProject": "Anderes Verzeichnis durchsuchen und öffnen",
  "quickSwitcher.action.switchServer": "Server wechseln",
  "quickSwitcher.label.current": "Aktuell",
  "session.child.promptDisabled": "Subagent-Sitzungen können nicht angesprochen werden.",
  "session.child.backToParent": "Zurück zur Hauptsitzung.",
  "toast.update.available.title": "Update verfügbar",
  "toast.update.available.description": "Version {{version}} kann installiert werden.",
  "toast.update.installing.title": "Update wird installiert",
  "toast.update.installing.description": "Einen Moment — das kann etwas dauern.",
  "toast.update.installed.title": "Update installiert",
  "toast.update.installed.description": "Zum Verwenden von Version {{version}} neu starten.",
  "toast.update.installed.descriptionRestartRequired": "Version {{version}} ist installiert. Starten Sie Codeplane neu, um sie zu verwenden.",
  "toast.update.installed.descriptionFallback": "Zum Anwenden des Updates neu starten.",
  "toast.update.upToDate.title": "Bereits aktuell",
  "toast.update.failed.title": "Update fehlgeschlagen",
  "toast.update.failed.description": "Update konnte nicht installiert werden.",
  "toast.update.action.updateNow": "Jetzt aktualisieren",
  "toast.update.action.later": "Später",
  "toast.update.action.restart": "Neu starten",
  "toast.update.action.retry": "Wiederholen",
  "toast.update.action.whatsNew": "Neuigkeiten",
  "toast.update.action.dismiss": "Schließen",
  "dialog.whatsNew.title": "Neuigkeiten in {{version}}",
  "dialog.whatsNew.subtitle": "Aktualisiert von {{previous}} → {{current}}",
  "dialog.whatsNew.empty": "Für diese Version sind keine Release-Notes verfügbar.",
  "dialog.whatsNew.action.viewFull": "Vollständige Version auf GitHub ansehen",
  "dialog.whatsNew.action.dismiss": "Verstanden",
  ...
  "session.liveActivity.menu.on": "Nicht mehr auf dem Sperrbildschirm anzeigen",
  "session.liveActivity.menu.off": "Auf dem Sperrbildschirm anzeigen",
  "session.liveActivity.menu.limit": "Sperrbildschirm voll ({{max}} Sitzungen)",
  "sidebar.home": "Start",
  "sidebar.modes": "Modi",
  ...
  "settings.general.row.showFileTree.description": "Dateibaum-Umschalter und -Panel in Sitzungen anzeigen",
  "settings.general.row.showNavigation.title": "Navigationselemente",
  "settings.general.row.showNavigation.description": "Zurück- und Vorwärts-Schaltflächen in der App-Kopfzeile anzeigen",
  "settings.general.row.showSearch.title": "Befehlspalette",
  "settings.general.row.showSearch.description": "Such- und Befehlspaletten-Schaltfläche in der App-Kopfzeile anzeigen",
  "settings.general.row.showTerminal.description": "Terminal-Schaltfläche in der App-Kopfzeile anzeigen",
  "settings.general.row.showStatus.title": "Serverstatus",
  "settings.general.row.showStatus.description": "Serverstatus-Schaltfläche in der App-Kopfzeile anzeigen",
  "settings.general.row.debugLogging.title": "Debug-Protokollierung",
  "settings.general.row.debugLogging.description": "Ausführliche Laufzeitprotokolle für vom Desktop verwaltete lokale Instanzen schreiben. Starten Sie eine laufende lokale Instanz neu, um die neue Stufe anzuwenden.",
  "settings.general.row.instanceLogs.title": "Instanzprotokolle",
  "settings.general.row.instanceLogs.description": "Protokollverzeichnis dieser lokalen Instanz öffnen.",
  "settings.general.row.instanceLogs.action.open": "Protokolle öffnen",
  "settings.general.row.instanceLogs.action.opening": "Wird geöffnet…",
  "settings.general.row.instanceLogs.unavailable": "Diese Instanz hat keine lokalen Protokolle auf diesem Desktop.",
  "settings.general.notifications.test.button": "Testbenachrichtigung senden",
  "settings.general.notifications.test.body": "Benachrichtigungen funktionieren — hier sehen Sie Systemmeldungen für die von Ihnen aktivierten Ereignisse.",
  "settings.general.notifications.permissionDenied": "Ihr Browser/Betriebssystem hat Benachrichtigungen für diese App blockiert. Aktivieren Sie sie in Ihren Systemeinstellungen.",
  "settings.permissions.section.tools": "Werkzeuge",
  "common.enabled": "Aktiviert",
  "common.remove": "Entfernen",
  "models.kind.override": "Überschreibung",
  ...
  "dialog.provider.anthropic.note": "Mit einem Anthropic-API-Schlüssel verbinden",
  ...
  "provider.connect.apiKey.description": "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codeplane zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix": ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Codeplane zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codeplane zu nutzen.",
  ...
  "provider.custom.models.fetch": "Modelle laden",
  "provider.custom.models.fetch.loading": "Lädt...",
  "provider.custom.models.fetch.success": "{{count}} Modelle geladen",
  "provider.custom.models.fetch.empty": "Keine Modelle gefunden",
  "provider.custom.models.fetch.error": "Modelle konnten von diesem Anbieter nicht geladen werden",
  ...
  "prompt.toast.screenshotUnsupported.description": "Dieser Browser stellt die Screen-Capture-API nicht bereit. Ziehen oder fügen Sie stattdessen ein Bild ein.",
  "prompt.toast.screenshotFailed.title": "Screenshot fehlgeschlagen",
  "prompt.toast.screenshotFailed.description": "Der ausgewählte Bildschirm konnte nicht erfasst werden. Bitte erneut versuchen oder das Bild manuell anhängen.",
  ...
  "dialog.plugins.empty": "Keine Plugins aus codeplane.jsonc oder config/plugins geladen",
  ...
  "dialog.server.title": "Instanzen",
  "dialog.server.description": "Wechseln Sie die Codeplane-Instanz, mit der diese App verbunden ist.",
  "dialog.server.search.placeholder": "Instanzen durchsuchen",
  "dialog.server.empty": "Noch keine Instanzen",
  "dialog.server.add.title": "Instanz hinzufügen",
  "dialog.server.add.url": "Instanz-Adresse",
  "dialog.server.add.error": "Instanz nicht erreichbar",
  "dialog.server.add.checking": "Prüfen...",
  "dialog.server.add.button": "Instanz hinzufügen",
  "dialog.server.add.name": "Instanz-Name (optional)",
  "dialog.server.add.username": "Benutzername (optional)",
  "dialog.server.add.password": "Passwort (optional)",
  "dialog.server.edit.title": "Instanz bearbeiten",
  "dialog.server.default.title": "Standard-Instanz",
  "dialog.server.default.description": "Beim App-Start mit dieser Instanz verbinden, anstatt eine neue lokale zu starten. Erfordert Neustart.",
  "dialog.server.default.none": "Keine Instanz ausgewählt",
  "dialog.server.default.set": "Aktuelle Instanz als Standard setzen",
  "dialog.server.default.clear": "Löschen",
  "dialog.server.action.remove": "Instanz entfernen",
  ...
  "dialog.server.current": "Aktuelle Instanz",
  ...
  "error.chain.mcpFailed": "MCP-Server \"{{name}}\" fehlgeschlagen. Hinweis: Codeplane unterstützt noch keine MCP-Authentifizierung.",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Fügt Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> zu Commits hinzu, die über Codeplane erstellt wurden",
  ...
  "settings.general.row.browserUse.description": "Ermöglicht dem Agenten die Steuerung eines isolierten Chrome-Browsers mit eigener virtueller Maus und Tastatur für UI-Tests und Debugging. Umfasst Navigation, Refs, Klicken, Hover, Ziehen, Tippen, Shortcuts, Screenshots, Konsolenprotokolle und JavaScript-Ausführung. Standardmäßig deaktiviert und nur in Codeplane Desktop verfügbar.",
  "settings.general.row.computerUse.title": "Computer-Steuerung",
  "settings.general.row.computerUse.description": "Ermöglicht dem Agenten, diesen Desktop über den echten Betriebssystem-Zeiger zu steuern: Screenshots, Mausbewegungen, Klicks, Ziehen, Scrollen, Tastatureingaben, Shortcuts und App-Start. Standardmäßig deaktiviert und nur in Codeplane Desktop verfügbar.",
  "settings.general.row.computerUse.permissionsTitle": "Berechtigungen benötigt für {{ tool }}",
  "settings.general.row.computerUse.permissionsBody": "{{ tool }} benötigt {{count}} Systemberechtigungen, um diesen Desktop zu steuern.",
  "settings.general.row.computerUse.permissionGranted": "Bereit",
  "settings.general.row.computerUse.permissionMissing": "Nicht aktiv",
  "settings.general.row.computerUse.permissionRelaunchRequired": "Neustart erforderlich",
  ...
  "settings.general.row.computerUse.permissionsFooter": "Wenn der Schalter in den Systemeinstellungen bereits aktiv ist, hier aber weiter als inaktiv erscheint, starte Codeplane Desktop neu, damit macOS die Berechtigung neu lädt.",
  "settings.general.row.computerUse.permissionsRelaunchFooter": "Die Berechtigung ist in den Systemeinstellungen aktiv, aber dieser laufende Codeplane-Prozess kann sie noch nicht verwenden. Starte Codeplane Desktop neu, um sie anzuwenden.",
  "settings.general.row.computerUse.permissionDone": "Schließen",
  "settings.general.row.computerUse.statusAllGranted": "Alle aktiv",
  "settings.general.row.computerUse.statusActivePartial": "{{active}} von {{total}} aktiv",
  "settings.general.row.computerUse.statusPartial": "{{granted}} von {{total}} erteilt",
  "settings.general.row.computerUse.statusRelaunchRequired": "Neustart erforderlich",
  ...
  "settings.general.row.computerUse.relaunchUnavailable.description": "Dieser Build kann sich nicht selbst neu starten. Beende Codeplane Desktop und öffne es manuell, damit die Berechtigungen wirksam werden.",
  ...
  "settings.general.row.computerUse.permissionDescription.accessibility": "Bewegt den Cursor, klickt, tippt und sendet Tastenkürzel.",
  "settings.general.row.computerUse.permissionDescription.screenRecording": "Macht Screenshots, damit der Agent den Desktop sieht.",
  "settings.general.row.computerUse.permissionDescription.generic": "Wird für Computer-Steuerung auf diesem Betriebssystem benötigt.",
  ...
  "settings.general.row.version.descriptionUnknownMethod": "Du nutzt Version {{current}}. Automatische Updates sind für diese Installation nicht verfügbar — bitte manuell aktualisieren.",
  "settings.general.row.version.descriptionDesktopManaged": "Du nutzt Version {{current}}. Updates werden von der Codeplane-Desktop-App verwaltet — öffne den Updates-Bereich der Desktop-App, um nach einer neuen Version zu suchen.",
  "settings.general.row.version.descriptionManagedLocal": "Du nutzt Version {{current}}. Diese lokale Laufzeit wird vom Launcher verwaltet; starte Codeplane neu, um eine neuere Laufzeit zu verwenden.",
  ...
  "archiveSessions.retention": "Archivierte Sitzungen sind schreibgeschützt. Sie werden nach 30 Tagen gelöscht und können nicht wiederhergestellt werden.",
  ...
  "session.archived.readOnly": "Diese Sitzung ist archiviert und schreibgeschützt. Archivierte Sitzungen werden nach 30 Tagen gelöscht.",
  ...
  "app.server.otherServers": "Andere Instanzen",

  "login.title": "Anmelden",
  "login.subtitle": "Gib deine Zugangsdaten ein, um auf {{server}} zuzugreifen",
  "login.username": "Benutzername",
  "login.usernamePlaceholder": "codeplane",
  ...
  "login.hint": "Deine Zugangsdaten werden nur auf diesem Gerät gespeichert.",
  "login.otp.title": "Zwei-Faktor-Authentifizierung",
  "login.otp.subtitle": "Gib den 6-stelligen Code aus deiner Authenticator-App ein.",
  "login.otp.code": "Authentifizierungscode",
  "login.otp.placeholder": "123456",
  "login.otp.verify": "Bestätigen",
  "login.otp.verifying": "Wird überprüft…",
  "login.otp.back": "Zurück",
  "login.otp.error": "Ungültiger oder abgelaufener Code",
  "login.otp.hint": "Öffne deine Authenticator-App, um den aktuellen Code zu erhalten.",
  "login.expired": "Deine Sitzung ist abgelaufen. Bitte melde dich erneut an.",
  "connect.title": "Mit Codeplane verbinden",
  "connect.subtitle": "Gib eine Serveradresse ein, um zu starten.",
  "connect.address": "Serveradresse",
  "connect.placeholder": "local, eine IP oder eine Domain",
  "connect.hint": "Versuche „local“, eine IP wie 192.168.1.5 oder eine Domain.",
  "connect.signIn": "Anmelden",
  "connect.connecting": "Verbinde…",
  "connect.error": "Server nicht erreichbar. Prüfe die Adresse und versuche es erneut.",
  ...
  "sidebar.restart.confirm": "Codeplane neu starten? Aktive Sitzungen werden neu verbunden, Modus-, Plugin- und MCP-Änderungen werden neu geladen.",
  ...
  "session.cron.readonly": "Dies ist eine Sitzung einer geplanten Aufgabe. Der Agent läuft autonom — Eingaben sind nicht möglich.",
  ...
  "mcp.editor.environment.description": "Werden als Env-Variablen an den lokalen Prozess übergeben. Werte sind maskiert — auf das Auge tippen, um sie anzuzeigen.",
  "mcp.editor.headers": "Header",
  "mcp.editor.headers.description": "Werden mit jeder Anfrage gesendet. Werte sind maskiert — auf das Auge tippen, um sie anzuzeigen.",
  ...
  "mcp.status.needs_client_registration": "benötigt Client-ID",
  "mcp.action.authorize": "Autorisieren",
  "mcp.action.authorizing": "Autorisierung läuft…",
  "mcp.action.signOut": "Abmelden",
  "mcp.toast.authorized": "{{name}} autorisiert",
  "mcp.toast.authFailed": "Autorisierung fehlgeschlagen",
  "mcp.toast.authTimeout": "Zeitüberschreitung bei der Autorisierung — bitte erneut versuchen",
  "mcp.toast.notSupported": "Dieser Server unterstützt kein OAuth",
  "mcp.toast.needsClientId": "Client-Registrierung erforderlich",
  "mcp.toast.signedOut": "Abgemeldet",
  "mcp.toast.popupBlocked": "Pop-ups für diese Seite zulassen und dann erneut autorisieren",
  "mcp.oauth.clientRegistrationHint":
    "Dieser Server benötigt eine vorregistrierte Client-ID. Füge oauth.clientId zu seiner Konfiguration hinzu.",
  ...
  "plugins.editor.specifier.description": "Paketname (mein-plugin), Pfad (./plugins/foo.ts) oder URL (https://example.com/plugin.js).",
  "plugins.editor.options": "Optionen",
  "plugins.editor.options.description": "Optionale Schlüssel-Wert-Konfiguration, die an das Plugin übergeben wird. Geheim aussehende Schlüssel sind maskiert — auf das Auge tippen, um sie anzuzeigen.",
