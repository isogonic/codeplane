export const dict = {
  ...
  "dialog.provider.codeplaneGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 CodePlane에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 CodePlane에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 CodePlane에서 {{provider}} 모델을 사용하세요.",
  ...
  "toast.update.description": "CodePlane의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 CodePlane 서버를 실행합니다.",
  ...
  "settings.updates.row.startup.description": "CodePlane를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 CodePlane를 사용 중입니다.",
