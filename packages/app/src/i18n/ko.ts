...
const translated = {
  ...
  "dialog.provider.codeplane.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.codeplane.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.anthropic.note": "Anthropic API 키로 연결",
  ...
  "dialog.model.unpaid.freeModels.title": "Codeplane에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description": "{{provider}} API 키를 입력하여 계정을 연결하고 Codeplane에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix": "를 방문하여 인증 코드를 받아 계정을 연결하고 Codeplane에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix": "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Codeplane에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "codeplane.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 Codeplane 서버를 전환합니다.",
  ...
  "error.chain.checkConfig": "구성(codeplane.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": "MCP 서버 \"{{name}}\" 실패. 참고: Codeplane는 아직 MCP 인증을 지원하지 않습니다.",
  ...
  "sidebar.gettingStarted.line1": "Codeplane에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "Codeplane 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Codeplane가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Codeplane가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Codeplane 테마 사용자 지정",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Codeplane을 통해 만든 커밋에 Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com>를 추가합니다",
  ...
  "login.title": "로그인",
  "login.subtitle": "{{server}}에 접속하려면 자격 증명을 입력하세요",
  ...
  "login.hint": "자격 증명은 이 기기에만 저장됩니다.",
