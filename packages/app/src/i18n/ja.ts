export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Codeplaneで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCodeplaneで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Codeplaneで{{provider}}モデルを使用してください。",
  ...
  "settings.general.row.codeplaneCoauthor.description":
    "Codeplane から作成されたコミットに Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> を追加します",
