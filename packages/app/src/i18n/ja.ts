export const dict = {
  ...
  "toast.update.description": "CodePlaneの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCodePlaneサーバーを実行します。",
  ...
  "settings.updates.row.startup.description": "CodePlane の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "CodePlane は最新バージョンです。",
