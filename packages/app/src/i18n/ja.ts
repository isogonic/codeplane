...
const translated = {
  "mcp.status.needs_client_registration": "クライアントIDが必要",
  "mcp.action.authorize": "認可する",
  "mcp.action.authorizing": "認可しています…",
  "mcp.action.signOut": "サインアウト",
  "mcp.toast.authorized": "{{name}} を認可しました",
  "mcp.toast.authFailed": "認可に失敗しました",
  "mcp.toast.authTimeout": "認可がタイムアウトしました — もう一度お試しください",
  "mcp.toast.notSupported": "このサーバーは OAuth に対応していません",
  "mcp.toast.needsClientId": "クライアント登録が必要です",
  "mcp.toast.signedOut": "サインアウトしました",
  "mcp.toast.popupBlocked": "このサイトのポップアップを許可してから、もう一度認可をお試しください",
  "mcp.oauth.clientRegistrationHint": "このサーバーには事前登録されたクライアントIDが必要です。設定に oauth.clientId を追加してください。",
  ...
  "dialog.provider.anthropic.note": "Anthropic APIキーで接続",
  ...
  "dialog.model.unpaid.freeModels.title": "Codeplaneが提供する無料モデル",
  ...
  "provider.connect.apiKey.description": "{{provider}}のAPIキーを入力してアカウントを接続し、Codeplaneで{{provider}}モデルを使用します。",
  ...
  "dialog.plugins.empty": "codeplane.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCodeplaneサーバーを切り替えます。",
  ...
  "error.chain.checkConfig": "config (codeplane.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": "MCPサーバー \"{{name}}\" が失敗しました。注意: CodeplaneはまだMCP認証をサポートしていません。",
  ...
  "sidebar.gettingStarted.line1": "Codeplaneには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Codeplaneの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのCodeplaneの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Codeplaneがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Codeplaneのテーマをカスタマイズします。",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Codeplane から作成されたコミットに Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> を追加します",
  ...
  "login.title": "サインイン",
  "login.subtitle": "{{server}} にアクセスするには認証情報を入力してください",
  ...
  "login.hint": "認証情報はこのデバイスにのみ保存されます。",
