...
const translated = {
  "mcp.status.needs_client_registration": "trenger klient-ID",
  "mcp.action.authorize": "Autoriser",
  "mcp.action.authorizing": "Autoriserer…",
  "mcp.action.signOut": "Logg ut",
  "mcp.toast.authorized": "Autoriserte {{name}}",
  "mcp.toast.authFailed": "Autorisering mislyktes",
  "mcp.toast.authTimeout": "Autoriseringen tidsavbrøt — prøv igjen",
  "mcp.toast.notSupported": "Denne serveren støtter ikke OAuth",
  "mcp.toast.needsClientId": "Klientregistrering kreves",
  "mcp.toast.signedOut": "Logget ut",
  "mcp.toast.popupBlocked": "Tillat sprettoppvinduer for dette nettstedet, og prøv å autorisere på nytt",
  "mcp.oauth.clientRegistrationHint": "Denne serveren trenger en forhåndsregistrert klient-ID. Legg til oauth.clientId i konfigurasjonen.",
  ...
  "dialog.provider.anthropic.note": "Koble til med en Anthropic API-nøkkel",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Codeplane",
  ...
  "provider.connect.apiKey.description": "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Codeplane.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i codeplane.json",
  ...
  "dialog.server.description": "Bytt hvilken Codeplane-server denne appen kobler til.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Codeplane-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codeplane.json)",
  "error.chain.mcpFailed": "MCP-server \"{{name}}\" mislyktes. Merk at Codeplane ikke støtter MCP-autentisering ennå.",
  ...
  "sidebar.gettingStarted.line1": "Codeplane inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Codeplane",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Codeplane ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Codeplane skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Codeplane er tematisert.",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Legg til Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> i commits laget gjennom Codeplane",
  ...
  "login.subtitle": "Skriv inn legitimasjonen din for å få tilgang til {{server}}",
  ...
  "login.hint": "Legitimasjonen din lagres bare på denne enheten.",
