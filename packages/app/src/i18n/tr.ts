...
const translated = {
  ...
  "dialog.provider.codeplane.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codeplane.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.anthropic.note": "Anthropic API anahtarıyla bağlan",
  ...
  "dialog.model.unpaid.freeModels.title": "Codeplane tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description": "Hesabınızı bağlamak ve Codeplane'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Lütfen ",
  "provider.connect.oauth.code.visit.link": "bu bağlantıyı",
  "provider.connect.oauth.code.visit.suffix": " ziyaret edin ve hesabınızı bağlamak, ayrıca Codeplane'da {{provider}} modellerini kullanmak için yetkilendirme kodunuzu alın.",
  ...
  "provider.connect.oauth.auto.visit.prefix": "Lütfen ",
  "provider.connect.oauth.auto.visit.link": "bu bağlantıyı",
  "provider.connect.oauth.auto.visit.suffix": " ziyaret edin, ardından hesabınızı bağlamak ve Codeplane'da {{provider}} modellerini kullanmak için aşağıdaki kodu girin.",
  ...
  "dialog.plugins.empty": "Eklentiler codeplane.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Codeplane sunucusuna bağlanacağını değiştirin.",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (codeplane.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed": "MCP sunucusu \"{{name}}\" başarısız oldu. Not: Codeplane henüz MCP kimlik doğrulamasını desteklemiyor.",
  ...
  "sidebar.gettingStarted.line1": "Codeplane ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.general.row.appearance.description": "Codeplane'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description": "Codeplane'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Codeplane'un temasını özelleştirin.",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Codeplane üzerinden yapılan commitlere Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> ekle",
  ...
  "login.subtitle": "{{server}} erişimi için kimlik bilgilerinizi girin",
  ...
  "login.hint": "Kimlik bilgileriniz yalnızca bu cihazda saklanır.",
