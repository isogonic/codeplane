...
const translated = {
  "mcp.status.needs_client_registration": "需要 client ID",
  "mcp.action.authorize": "授权",
  "mcp.action.authorizing": "正在授权…",
  "mcp.action.signOut": "退出登录",
  "mcp.toast.authorized": "已授权 {{name}}",
  "mcp.toast.authFailed": "授权失败",
  "mcp.toast.authTimeout": "授权超时——请重试",
  "mcp.toast.notSupported": "此服务器不支持 OAuth",
  "mcp.toast.needsClientId": "需要注册 client",
  "mcp.toast.signedOut": "已退出登录",
  "mcp.toast.popupBlocked": "请允许此站点的弹出窗口，然后重新尝试授权",
  "mcp.oauth.clientRegistrationHint": "此服务器需要预先注册的 client ID。请在其配置中添加 oauth.clientId。",
  ...
  "dialog.model.unpaid.freeModels.title": "Codeplane 提供的免费模型",
  ...
  "provider.connect.apiKey.description": "输入你的 {{provider}} API 密钥以连接帐户，并在 Codeplane 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Codeplane 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Codeplane 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 codeplane.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Codeplane 服务器。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Codeplane 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (codeplane.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": "MCP 服务器 \"{{name}}\" 启动失败。注意: Codeplane 暂不支持 MCP 认证。",
  ...
  "sidebar.gettingStarted.line1": "Codeplane 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Codeplane 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Codeplane 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Codeplane 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Codeplane 的主题。",
  ...
  "settings.general.row.codeplaneCoauthor.description": "为通过 Codeplane 创建的提交添加 Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com>",
