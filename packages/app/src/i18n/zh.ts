...
export const dict = {
  ...
  "dialog.provider.codeplane.note": "使用 CodePlane Zen 或 API 密钥连接",
  "dialog.provider.codeplane.tagline": "可靠的优化模型",
  "dialog.provider.codeplaneGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 CodePlane 中使用 {{provider}} 模型。",
  ...
  "provider.connect.codeplaneZen.line1": "CodePlane Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.codeplaneZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.codeplaneZen.visit.prefix": "访问 ",
  "provider.connect.codeplaneZen.visit.link": "example.invalid/zen",
  "provider.connect.codeplaneZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "toast.update.description": "CodePlane 有新版本 ({{version}}) 可安装。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 CodePlane 服务器。",
  ...
  "settings.updates.row.startup.description": "在 CodePlane 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 CodePlane。",
