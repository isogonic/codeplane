...
const translated = {
  "mcp.status.needs_client_registration": "wymaga identyfikatora klienta",
  "mcp.action.authorize": "Autoryzuj",
  "mcp.action.authorizing": "Autoryzowanie…",
  "mcp.action.signOut": "Wyloguj",
  "mcp.toast.authorized": "Autoryzowano {{name}}",
  "mcp.toast.authFailed": "Autoryzacja nie powiodła się",
  "mcp.toast.authTimeout": "Upłynął limit czasu autoryzacji — spróbuj ponownie",
  "mcp.toast.notSupported": "Ten serwer nie obsługuje OAuth",
  "mcp.toast.needsClientId": "Wymagana rejestracja klienta",
  "mcp.toast.signedOut": "Wylogowano",
  "mcp.toast.popupBlocked": "Zezwól na wyskakujące okienka dla tej witryny, a następnie spróbuj autoryzować ponownie",
  "mcp.oauth.clientRegistrationHint": "Ten serwer wymaga wstępnie zarejestrowanego identyfikatora klienta. Dodaj oauth.clientId do jego konfiguracji.",
  ...
  "dialog.provider.codeplane.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codeplane.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.anthropic.note": "Połącz za pomocą klucza API Anthropic",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Codeplane",
  ...
  "provider.connect.apiKey.description": "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Codeplane.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codeplane.json",
  ...
  "dialog.server.description": "Przełącz serwer Codeplane, z którym łączy się ta aplikacja.",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codeplane.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Codeplane zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Codeplane",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Codeplane na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description": "Wybierz, czy Codeplane ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Codeplane.",
  ...
  "settings.general.row.codeplaneCoauthor.title": "Współautor Codeplane",
  "settings.general.row.codeplaneCoauthor.description": "Dodaj Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> do commitów utworzonych przez Codeplane",
  ...
  "login.subtitle": "Wprowadź swoje dane logowania, aby uzyskać dostęp do {{server}}",
  ...
  "login.hint": "Twoje dane logowania są przechowywane tylko na tym urządzeniu.",
