export const dict = {
  ...
  "dialog.provider.codeplaneGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodePlane.",
  ...
  "provider.connect.codeplaneZen.line1":
    "CodePlane Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodePlane.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodePlane.",
  ...
  "toast.update.description": "Nowa wersja CodePlane ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CodePlane ma używać motywu systemowego, jasnego czy ciemnego",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodePlane",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodePlane.",
