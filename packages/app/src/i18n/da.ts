...
const translated = {
  ...
  "provider.connect.apiKey.description": "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Codeplane.",
  ...
  "provider.connect.oauth.code.visit.suffix": " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Codeplane.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Codeplane.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codeplane.json",
  ...
  "settings.general.row.codeplaneCoauthor.description": "Føj Co-Authored-By: codeplane-agent[bot] <287208015+codeplane-agent[bot]@users.noreply.github.com> til commits lavet via Codeplane",
  ...
  "login.title": "Log ind",
  "login.subtitle": "Indtast dine legitimationsoplysninger for at få adgang til {{server}}",
  ...
  "login.hint": "Dine legitimationsoplysninger gemmes kun på denne enhed.",
