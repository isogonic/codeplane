  ...
  return (
    ...
    >
      ...
      <div class="min-w-0 flex items-center justify-center pointer-events-none">
        <div id="codeplane-titlebar-center" class="pointer-events-auto min-w-0 flex justify-center w-fit max-w-full" />
      </div>
      ...
      <div
        ...
        onMouseDown={drag}
      >
        <div id="codeplane-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
        <Show when={windows()}>
