...
beforeAll(async () => {
  ...
  mock.module("@codeplane-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codeplane-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codeplane-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codeplane-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
