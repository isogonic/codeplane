            ...
            <Tooltip
              ...
              value={
                <ModelTooltip
                  model={item}
                  latest={item.latest}
                  free={item.provider.id === "codeplane" && (!item.cost || item.cost.input === 0)}
                />
              }
            >
              {node}
                ...
                {(i) => (
                  <div class="w-full flex items-center gap-x-3">
                    ...
                    <Show when={i.id === "codeplane"}>
                      <div class="text-14-regular text-text-weak">{language.t("dialog.provider.codeplane.tagline")}</div>
                    </Show>
                    <Show when={i.id === "codeplane"}>
                    ...
                    <Show when={i.id === "codeplane-go"}>
                      <>
                        <div class="text-14-regular text-text-weak">
                          {language.t("dialog.provider.codeplaneGo.tagline")}
                        </div>
                        <Tag>{language.t("dialog.provider.tag.recommended")}</Tag>
                      </>
                    </Show>
