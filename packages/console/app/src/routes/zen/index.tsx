...
import compareVideo from "../../asset/lander/codeplane-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/codeplane-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="codeplane:auth" content={loggedin() ? "true" : "false"} />
