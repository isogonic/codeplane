...
import video from "../asset/lander/codeplane-min.mp4"
import videoPoster from "../asset/lander/codeplane-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">codeplane-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">devinoldenburg/tap/codeplane</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
