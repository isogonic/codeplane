...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | codeplane",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "codeplane açık logo",
  "notFound.logoDarkAlt": "codeplane koyu logo",
  ...
  "temp.title": "codeplane | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "codeplane tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "codeplane TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı codeplane TUI",
  ...
  "home.what.body":
    "CodePlane, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.faq.a1":
    "CodePlane, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  ...
  "home.faq.q5": "CodePlane'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! CodePlane artık sizin bu cihazlarınıza",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman codeplane ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve codeplane seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "codeplane'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "codeplane hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir codeplane Gateway API anahtarı oluşturun",
  ...
  "download.meta.description": "CodePlane'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "CodePlane'u İndir",
