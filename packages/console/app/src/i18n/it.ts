...
export const dict = {
  ...
  "notFound.title": "Non trovato | codeplane",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di codeplane",
  "notFound.logoDarkAlt": "logo scuro di codeplane",
  ...
  "temp.title": "codeplane | Agente di coding IA costruito per il terminale",
  ...
  "temp.screenshot.caption": "CodePlane TUI con il tema tokyonight",
  ...
  "home.what.body": "CodePlane è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.faq.a1":
    "CodePlane è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  ...
  "home.faq.q5": "Posso usare CodePlane solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! CodePlane ora è disponibile come app per",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con codeplane quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona codeplane",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia codeplane ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi codeplane.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API codeplane Gateway",
  ...
  "download.meta.description": "Scarica CodePlane per macOS, Windows e Linux",
  "download.hero.title": "Scarica CodePlane",
