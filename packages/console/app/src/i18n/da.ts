...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | codeplane",
  ...
  "temp.title": "codeplane | AI-kodningsagent bygget til terminalen",
  ...
  "temp.screenshot.caption": "codeplane TUI med tokyonight-temaet",
  "temp.screenshot.alt": "codeplane TUI med tokyonight-temaet",
  ...
  "home.what.body":
    "CodePlane er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.faq.a1":
    "CodePlane er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  ...
  "home.faq.q5": "Kan jeg kun bruge CodePlane i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! CodePlane er nu tilgængelig som en app til",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med codeplane, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg codeplane",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start codeplane og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til codeplane-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en codeplane Gateway API-nøgle",
  ...
  "download.meta.description": "Download CodePlane til macOS, Windows og Linux",
