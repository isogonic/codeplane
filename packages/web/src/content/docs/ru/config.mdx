...
Файл конфигурации имеет схему, определенную в [**`example.invalid/config.json`**](https://example.invalid/config.json).

Конфигурация TUI использует [**`example.invalid/tui.json`**]().
