...
1. Запустите команду `/connect` в TUI, выберите `CodePlane Zen` и перейдите по адресу [codeplane.ai/auth](https://codeplane.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `CodePlane Go` и перейдите по адресу [codeplane.ai/auth](https://codeplane.ai/zen).
