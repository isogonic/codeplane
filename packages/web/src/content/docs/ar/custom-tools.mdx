...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في codeplane.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في codeplane مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.codeplane/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/codeplane/tools/`.
