...
1. شغّل الأمر `/connect` في TUI، واختر codeplane، ثم انتقل إلى [codeplane.ai/auth](https://codeplane.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `CodePlane Go`، ثم انتقل إلى [codeplane.ai/auth](https://codeplane.ai/zen).
