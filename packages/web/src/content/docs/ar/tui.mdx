---
title: TUI
description: استخدام واجهة المستخدم TUI في CodePlane.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر CodePlane واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل CodePlane إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة CodePlane في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى CodePlane. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من CodePlane. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات CodePlane.
...
استخدم `CODEPLANE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
