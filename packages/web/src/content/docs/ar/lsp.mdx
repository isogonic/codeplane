---
title: خوادم LSP
description: يتكامل CodePlane مع خوادم LSP لديك.
---

يتكامل CodePlane مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي CodePlane مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `CODEPLANE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح codeplane ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات codeplane.
