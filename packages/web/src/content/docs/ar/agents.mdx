...
يستخدم معرّف النموذج في إعدادات Codeplane الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم Codeplane، فستستخدم `codeplane/gpt-5.1-codex` لـ GPT 5.1 Codex.
