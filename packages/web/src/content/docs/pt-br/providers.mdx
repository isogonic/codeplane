...
1. Execute o comando `/connect` no TUI, selecione `CodePlane Zen` e acesse [codeplane.ai/zen](https://codeplane.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `CodePlane Go` e acesse [codeplane.ai/zen](https://codeplane.ai/zen).
