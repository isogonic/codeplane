---
title: TUI
description: Usando a interface de usuário de terminal codeplane.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O codeplane fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar codeplane inicia o TUI para o diretório atual.
...
Ao usar o TUI do codeplane, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao codeplane. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do codeplane. _Aliases_: `/quit`, `/q`
...
Isso é separado do `codeplane.json`, que configura o comportamento do servidor/runtime.
...
Use `CODEPLANE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
