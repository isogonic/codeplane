---
title: Compartilhar
description: Compartilhe suas conversas do codeplane.
---

O recurso de compartilhamento do codeplane permite que você crie links públicos para suas conversas do codeplane, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o codeplane:
...
O codeplane suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o codeplane usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `codeplane.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o codeplane em sua organização.
