...
Brug den til at bygge integrasjoner og kontrollere codeplane programmatisk.
...
Opret en forekomst av codeplane:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `codeplane.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av codeplane, kan du oprete en klientforekomst for at koble til den:
