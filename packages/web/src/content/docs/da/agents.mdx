...
Model-id'et i din Codeplane-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger Codeplane, vil du bruge `codeplane/gpt-5.1-codex` til GPT 5.1 Codex.
