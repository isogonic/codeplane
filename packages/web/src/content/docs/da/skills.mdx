...
Agentferdigheter lar Codeplane oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Codeplane opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Codeplane viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `codeplane.json`:
