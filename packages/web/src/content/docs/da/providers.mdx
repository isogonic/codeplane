...
1. Kør kommandoen `/connect` i TUI, vælg codeplane og gå til [codeplane.ai/auth](https://codeplane.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `CodePlane Go`, og gå til [codeplane.ai/auth](https://codeplane.ai/zen).
