---
title: LSP-servere
description: Codeplane integreres med dine LSP-servere.
---

Codeplane integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Codeplane leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `CODEPLANE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når codeplane åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din codeplane-konfiguration.
