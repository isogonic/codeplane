---
title: TUI
description: Brug af CodePlane-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodePlane giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CodePlane starter TUI for den nuværende mappe.
...
Når du bruger CodePlane TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CodePlane. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CodePlane. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `codeplane.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `CODEPLANE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
