...
description: Lag verktøy som LLM kan kalle inn Codeplane.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Codeplane sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.codeplane/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/codeplane/tools/`.
