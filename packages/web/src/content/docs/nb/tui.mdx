---
title: TUI
description: Bruke codeplane-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodePlane gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre CodePlane starter TUI for gjeldende katalog.
...
Når du bruker CodePlane TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til CodePlane. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt CodePlane. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `codeplane.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `CODEPLANE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
