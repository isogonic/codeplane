...
Modellen ID i Codeplane-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker Codeplane, vil du bruke `codeplane/gpt-5.1-codex` for GPT 5.1 Codex.
