...
1. Kjør kommandoen `/connect` i TUI, velg `CodePlane Zen` og gå til [codeplane.ai/auth](https://codeplane.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `CodePlane Go`, og gå til [codeplane.ai/auth](https://codeplane.ai/zen).
