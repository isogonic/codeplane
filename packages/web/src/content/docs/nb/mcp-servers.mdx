...
Du kan definere MCP-servere i [CodePlane Config](https://codeplane.ai/docs/config/) under `mcp`. Legg til hver MCP med et unikt navn. Du kan referere til den MCP ved navn når du spør LLM-en.
