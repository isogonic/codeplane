...
Opprett `.codeplane/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CodePlane-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CodePlane [config](/docs/config):
...
- Per prosjekt: `.codeplane/commands/`
...
CodePlane inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
