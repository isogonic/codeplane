...
codeplane yapılandırmanızdaki model kimliği `provider/model-id` biçimini kullanır. Örneğin, Codeplane kullanıyorsanız, GPT 5.1 Codex için `codeplane/gpt-5.1-codex` kullanırsınız.
