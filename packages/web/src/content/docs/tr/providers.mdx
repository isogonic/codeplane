...
1. TUI'de `/connect` komutunu çalıştırın, codeplane'u seçin ve [codeplane.ai/auth](https://codeplane.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `CodePlane Go`'yu seçin ve [codeplane.ai/auth](https://codeplane.ai/zen) adresine gidin.
