...
codeplane, kurumsal ağ ortamları için standart proxy ortam değişkenlerini ve özel sertifikaları destekler.
...
Kuruluşunuz HTTPS bağlantıları için özel CA'lar kullanıyorsa, codeplane'u bunlara güvenecek şekilde yapılandırın.
