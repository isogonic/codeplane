---
title: Özel Araçlar
description: LLM'un codeplane'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. codeplane'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.codeplane/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/codeplane/tools/` içine yerleştirerek.
