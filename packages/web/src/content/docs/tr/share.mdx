---
title: Paylasim
description: codeplane konusmalarini genel baglantilarla paylasin.
---

codeplane'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda codeplane:
...
codeplane, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak codeplane manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `codeplane.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda codeplane kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
