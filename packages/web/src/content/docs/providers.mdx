...
1. Run the `/connect` command in the TUI, select `CodePlane Zen`, and head to [example.invalid/auth](https://example.invalid/zen).
...
1. Run the `/connect` command in the TUI, select `CodePlane Go`, and head to [example.invalid/auth](https://example.invalid/zen).
