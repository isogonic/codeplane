...
1. Run the `/connect` command in the TUI, select `CodePlane Zen`, and head to [codeplane.ai/auth](https://codeplane.ai/zen).
...
1. Run the `/connect` command in the TUI, select `CodePlane Go`, and head to [codeplane.ai/auth](https://codeplane.ai/zen).
