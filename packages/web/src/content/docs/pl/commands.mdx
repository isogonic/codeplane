...
Utwórz `.codeplane/commands/test.md`:
...
Możesz zdefiniować polecenia w `codeplane.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji codeplane:
...
- Globalnie: `~/.config/codeplane/commands/`
- Na projekt: `.codeplane/commands/`
...
codeplane zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
