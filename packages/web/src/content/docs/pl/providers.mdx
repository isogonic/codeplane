...
1. Uruchom polecenie `/connect` w TUI, wybierz `CodePlane Zen` i przejdź do [codeplane.ai/auth](https://codeplane.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `CodePlane Go` i przejdź do [codeplane.ai/auth](https://codeplane.ai/zen).
