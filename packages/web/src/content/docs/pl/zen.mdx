---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CodePlane.
---
...
CodePlane Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół CodePlane.

:::note
CodePlane Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w CodePlane. Logujesz się do CodePlane Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z CodePlane.
:::
...
CodePlane Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

CodePlane Zen działa jak każdy inny dostawca w CodePlane.

1. Logujesz się do **<a href={console}>CodePlane Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz CodePlane Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji CodePlane używa formatu
`codeplane/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`codeplane/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w CodePlane przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w CodePlane przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w CodePlane przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w CodePlane przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w CodePlane przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy CodePlane Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w CodePlane także dowolnego innego dostawcy.
