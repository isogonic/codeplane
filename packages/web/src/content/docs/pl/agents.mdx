...
Identyfikator modelu jest taki sam, jak w konfiguracji Codeplane w `provider/model-id`. Na przykład, Codeplane, użyj `codeplane/gpt-5.1-codex` dla GPT 5.1 Codex.
