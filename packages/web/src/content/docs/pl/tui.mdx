---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala codeplane.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

codeplane zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie codeplane uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI codeplane, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do codeplane. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij codeplane. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `codeplane.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `CODEPLANE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
