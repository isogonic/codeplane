---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące codeplane.
---

Funkcja udostępniania codeplane umożliwia tworzenie publicznych linków do konwersacji codeplane, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, codeplane:
...
codeplane obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie codeplane korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `codeplane.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu codeplane w Twojej organizacji.
