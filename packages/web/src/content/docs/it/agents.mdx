...
L'ID modello nella configurazione Codeplane usa il formato `provider/model-id`. Per esempio, se stai usando Codeplane, useresti `codeplane/gpt-5.1-codex` per GPT 5.1 Codex.
