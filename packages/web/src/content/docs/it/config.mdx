...
Il file di configurazione ha uno schema definito in [**`example.invalid/config.json`**](https://example.invalid/config.json).

La configurazione TUI usa [**`example.invalid/tui.json`**]().
