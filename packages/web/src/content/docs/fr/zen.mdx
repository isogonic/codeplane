...
| --------------------- | --------------------- | -------------------------------------------------- | --------------------------- |
| GPT 5.5               | gpt-5.5               | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.5 Pro           | gpt-5.5-pro           | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.4               | gpt-5.4               | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.4 Pro           | gpt-5.4-pro           | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.4 Mini          | gpt-5.4-mini          | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.4 Nano          | gpt-5.4-nano          | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex         | gpt-5.3-codex         | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark   | gpt-5.3-codex-spark   | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.2               | gpt-5.2               | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex         | gpt-5.2-codex         | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.1               | gpt-5.1               | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex         | gpt-5.1-codex         | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max     | gpt-5.1-codex-max     | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini    | gpt-5.1-codex-mini    | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5                 | gpt-5                 | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5 Codex           | gpt-5-codex           | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| GPT 5 Nano            | gpt-5-nano            | `https://example.invalid/zen`             | `@ai-sdk/openai`            |
| Claude Opus 4.7       | claude-opus-4-7       | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6       | claude-opus-4-6       | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5       | claude-opus-4-5       | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1       | claude-opus-4-1       | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6     | claude-sonnet-4-6     | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5     | claude-sonnet-4-5     | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4       | claude-sonnet-4       | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5      | claude-haiku-4-5      | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5      | claude-3-5-haiku      | `https://example.invalid/zen`              | `@ai-sdk/anthropic`         |
| Gemini 3.1 Pro        | gemini-3.1-pro        | `https://example.invalid/zen` | `@ai-sdk/google`            |
| Gemini 3 Flash        | gemini-3-flash        | `https://example.invalid/zen` | `@ai-sdk/google`            |
| Qwen3.6 Plus          | qwen3.6-plus          | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Qwen3.5 Plus          | qwen3.5-plus          | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5          | minimax-m2.5          | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free     | minimax-m2.5-free     | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.7          | minimax-m2.7          | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| GLM 5.1               | glm-5.1               | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| GLM 5                 | glm-5                 | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5             | kimi-k2.5             | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Kimi K2.6             | kimi-k2.6             | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Big Pickle            | big-pickle            | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Ling 2.6 Flash        | ling-2.6-flash        | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Hy3 Preview Free      | hy3-preview-free      | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://example.invalid/zen`      | `@ai-sdk/openai-compatible` |
