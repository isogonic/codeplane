...
Le fichier de configuration a un schéma défini dans [**`example.invalid/config.json`**](https://example.invalid/config.json).

La configuration TUI utilise [**`example.invalid/tui.json`**]().
