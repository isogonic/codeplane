...
L'ID de modèle dans votre configuration Codeplane utilise le format `provider/model-id`. Par exemple, si vous utilisez Codeplane, vous utiliserez `codeplane/gpt-5.1-codex` pour GPT 5.1 Codex.
