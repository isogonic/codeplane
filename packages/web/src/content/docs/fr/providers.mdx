...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez codeplane et dirigez-vous vers [codeplane.ai/auth](https://codeplane.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `CodePlane Go` et rendez-vous sur [codeplane.ai/auth](https://codeplane.ai/zen).
