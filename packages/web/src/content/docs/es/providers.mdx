...
1. Ejecute el comando `/connect` en TUI, seleccione codeplane y diríjase a [codeplane.ai/auth](https://codeplane.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `CodePlane Go` y diríjase a [codeplane.ai/auth](https://codeplane.ai/zen).
