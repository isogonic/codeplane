...
Crear `.codeplane/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CodePlane o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CodePlane [config](/docs/config):
...
- Por proyecto: `.codeplane/commands/`
...
codeplane incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
