...
El ID del modelo en su configuración Codeplane usa el formato `provider/model-id`. Por ejemplo, si usa Codeplane, usaría `codeplane/gpt-5.1-codex` para GPT 5.1 Codex.
