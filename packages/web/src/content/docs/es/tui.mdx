---
title: TUI
description: Usando la interfaz de usuario del terminal CodePlane.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodePlane proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CodePlane se inicia TUI para el directorio actual.
...
Cuando utilice CodePlane TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CodePlane. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CodePlane. _Alias_: `/quit`, `/q`
...
Esto es independiente de `codeplane.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `CODEPLANE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
