...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก codeplane และไปที่ [codeplane.ai/auth](https://codeplane.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `CodePlane Go` และไปที่ [codeplane.ai/auth](https://codeplane.ai/zen)
