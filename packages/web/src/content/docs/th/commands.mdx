...
สร้าง `.codeplane/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ CodePlane:
...
- ระดับผู้ใช้ (Global): `~/.config/codeplane/commands/`
- ระดับโปรเจ็กต์: `.codeplane/commands/`
...
CodePlane มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
