---
title: Teilen
description: Teile CodePlane-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CodePlane-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CodePlane Folgendes:
...
CodePlane hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CodePlane den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codeplane.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codeplane in deiner Organisation einsetzt.
