---
title: TUI
description: Arbeite mit CodePlane in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodePlane bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet CodePlane die TUI im aktuellen Verzeichnis.
...
In der CodePlane-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu CodePlane hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet CodePlane. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `codeplane.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `CODEPLANE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
