...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie CodePlane aus und gehen Sie zu [codeplane.ai/auth](https://codeplane.ai/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `CodePlane Go` und gehen Sie zu [codeplane.ai/auth](https://codeplane.ai/zen).
