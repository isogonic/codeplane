...
Die Modell-ID in Ihrer Codeplane-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise Codeplane verwenden, würden Sie `codeplane/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
