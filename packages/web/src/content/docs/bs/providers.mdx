...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite codeplane i idite na [codeplane.ai/auth](https://codeplane.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `CodePlane Go` i idite na [codeplane.ai/auth](https://codeplane.ai/zen).
