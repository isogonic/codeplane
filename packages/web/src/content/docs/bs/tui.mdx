---
title: TUI
description: Korištenje korisničkog interfejsa CodePlane terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodePlane pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CodePlane pokreće TUI za trenutni direktorij.
...
Kada koristite CodePlane TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CodePlane. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CodePlane. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `codeplane.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `CODEPLANE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
