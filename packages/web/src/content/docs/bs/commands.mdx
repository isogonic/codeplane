...
Kreiraj `.codeplane/commands/test.md`:
...
Možete dodati prilagođene komande kroz CodePlane konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CodePlane [config](/docs/config):
...
- Globalno: `~/.config/codeplane/commands/`
- Po projektu: `.codeplane/commands/`
...
CodePlane uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
