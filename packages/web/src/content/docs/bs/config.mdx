...
Konfiguracijski fajl ima šemu koja je definirana u [**`example.invalid/config.json`**](https://example.invalid/config.json).

TUI konfiguracija koristi [**`example.invalid/tui.json`**]().
