...
ID modela u vašoj Codeplane konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite Codeplane, koristili biste `codeplane/gpt-5.1-codex` za GPT 5.1 Codex.
