...
1. 在 TUI 中執行 `/connect` 指令，選擇 `CodePlane Zen`，然後前往 [codeplane.ai/auth](https://codeplane.ai/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `CodePlane Go`，然後前往 [codeplane.ai/auth](https://codeplane.ai/zen)。
