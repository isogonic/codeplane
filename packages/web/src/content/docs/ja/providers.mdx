...
1. TUI で `/connect` コマンドを実行し、`CodePlane Zen` を選択して、[codeplane.ai/zen](https://codeplane.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`CodePlane Go` を選択して、[codeplane.ai/zen](https://codeplane.ai/zen) にアクセスします。
