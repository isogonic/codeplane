...
import { IconCodeplane } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "codeplane/session/message-v2"
import type { Message } from "codeplane/session/message"
import type { Session } from "codeplane/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.codeplane_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.codeplane_name}>
                    <IconCodeplane width={16} height={16} />
                  </div>
