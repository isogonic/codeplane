...
import { sanitizedProcessEnv } from "@/util/codeplane-process"
...
export class Service extends Context.Service<Service, Interface>()("@codeplane/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".codeplane")) continue
