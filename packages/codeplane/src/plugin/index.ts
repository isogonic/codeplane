...
export class Service extends Context.Service<Service, Interface>()("@codeplane/Plugin") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        const client = createCodeplaneClient({
          ...
          headers: Flag.CODEPLANE_SERVER_PASSWORD
            ? {
        ...
        const plugins = Flag.CODEPLANE_PURE ? [] : (cfg.plugin_origins ?? [])
        if (Flag.CODEPLANE_PURE && cfg.plugin_origins?.length) {
