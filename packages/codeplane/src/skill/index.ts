...
const CODEPLANE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.CODEPLANE_DISABLE_EXTERNAL_SKILLS) {
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, CODEPLANE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@codeplane/Skill") {}
