...
import type { PermissionRequest } from "@/tui/_compat/sdk-v2"
...
import { ShellID } from "@/tui/_compat/tool-shell-id"
          ...
          body={
            <Switch>
              <Match when={props.request.always.length === 1 && props.request.always[0] === "*"}>
                <TextBody title={"This will allow " + props.request.permission + " until Codeplane is restarted."} />
              </Match>
              <Match when={true}>
                <box paddingLeft={1} gap={1}>
                  <text fg={theme.textMuted}>This will allow the following patterns until Codeplane is restarted</text>
                  <box>
