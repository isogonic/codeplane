...
import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@codeplane-ai/plugin/tui"
...
export function createTuiApi(input: Input): TuiPluginApi {
  ...
  return {
    ...
    // useEvent's `on` is keyed off the augmented Event union (SDK + TUI-local
    // events); TuiEventBus is keyed off the SDK Event union. Same dispatch
    // surface at runtime — TS just can't unify the two conditional types.
