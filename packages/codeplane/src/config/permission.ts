...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    project: Schema.optional(Rule),
    tools: Schema.optional(Rule),
    git: Schema.optional(Rule),
    forge: Schema.optional(Rule),
    bash: Schema.optional(Rule),
    task: Schema.optional(Rule),
    browser: Schema.optional(Rule),
    computer: Schema.optional(Rule),
    ...
    z.intersection(
      ...
      z
        .object({
          ...
          project: zod(Rule).optional(),
          tools: zod(Rule).optional(),
          git: zod(Rule).optional(),
          forge: zod(Rule).optional(),
          bash: zod(Rule).optional(),
          task: zod(Rule).optional(),
          browser: zod(Rule).optional(),
          computer: zod(Rule).optional(),
