...
export const Flag = {
  ...
  // Base32 TOTP secret enabling two-factor auth on top of the Basic Auth
  // password. When set (and a password is also set), clients must present a
  // valid 6-digit code after the password. Generated by `codeplane totp`.
  CODEPLANE_SERVER_TOTP_SECRET: process.env["CODEPLANE_SERVER_TOTP_SECRET"],
