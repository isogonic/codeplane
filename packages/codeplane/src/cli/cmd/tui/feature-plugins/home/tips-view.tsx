...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at example.invalid",
  ...
  "Create JSON theme files in {highlight}.codeplane/themes/{/highlight} directory",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/devinoldenburg/codeplane{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with CodePlane Zen for curated, tested models",
