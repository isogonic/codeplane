...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codeplane.git")).toEqual({ owner: "sst", repo: "codeplane" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codeplane")).toEqual({ owner: "sst", repo: "codeplane" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codeplane.git")).toEqual({ owner: "sst", repo: "codeplane" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codeplane")).toEqual({ owner: "sst", repo: "codeplane" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codeplane.git")).toEqual({ owner: "sst", repo: "codeplane" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codeplane")).toEqual({ owner: "sst", repo: "codeplane" })
})
