...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODEPLANE_CALLER", () => {
    process.env["CODEPLANE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODEPLANE_CALLER", () => {
    process.env["CODEPLANE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODEPLANE_CALLER", () => {
    process.env["CODEPLANE_CALLER"] = "unknown"
