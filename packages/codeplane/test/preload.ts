...
const dir = path.join(os.tmpdir(), "codeplane-test-data-" + process.pid)
...
process.env["CODEPLANE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["CODEPLANE_DISABLE_DEFAULT_PLUGINS"] = "true"

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "codeplane")
