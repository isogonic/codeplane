...
- request, CLI, web, and tool entrypoints shift into an instance through Effect, not `Instance.provide(...)`
...
Current total: `56` files in `packages/codeplane/src`.
...
- path: `/Users/kit/code/open-source/codeplane-worktrees/instance-effect-shift`
