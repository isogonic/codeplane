...
Practical reference for the current tool-migration state in `packages/codeplane`.
...
Tool tests should use the existing Effect helpers in `packages/codeplane/test/lib/effect.ts`:
