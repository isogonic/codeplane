...
import type {
  ...
  ProviderCustomModelsErrors,
  ProviderCustomModelsResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CodeplaneClient()" to fix this error.`)
    }
    return instance
  }
...
export class Provider extends HeyApiClient {
   ...
   */
  public customModels<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      baseURL?: string
...
export class CodeplaneClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CodeplaneClient>()
