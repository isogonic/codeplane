export const dict = {
  ...
  "desktop.menu.help.documentation": "CodePlane Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "CodePlane CLI binary is missing. Try reinstalling the desktop app.",
