export const dict = {
  ...
  "desktop.menu.help.documentation": "CodePlane Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CodePlane CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
