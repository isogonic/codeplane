    ...
    items: [
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            ...
            action: () => trigger("app.checkUpdates"),
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinoldenburg/codeplane"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/codeplane"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinoldenburg/codeplane/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinoldenburg/codeplane/issues/new?template=bug_report.yml"),
